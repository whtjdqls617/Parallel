...
/// Airplane window — dark cabin, bright sky beyond the glass.
...
class _RainSceneState extends State<RainScene>
  ...
  @override
  void didUpdateWidget(covariant RainScene oldWidget) {
  ...
  void _maybeSettleSand(double t) {
    ...
    final total = RainPainter.sandEraseSeconds +
        RainPainter.sandPauseSeconds +
        RainPainter.sandWriteSeconds;
  ...
  int _currentSandCount(double t) {
    ...
    final u = t - changeAt;
    if (u < RainPainter.sandEraseSeconds) return from;
    return to;
  }
  ...
  ({int sandCount, double reveal, double erase}) _sandInscription(double t) {
    ...
    final u = t - changeAt;
    const eraseDur = RainPainter.sandEraseSeconds;
    const pauseDur = RainPainter.sandPauseSeconds;
    const writeDur = RainPainter.sandWriteSeconds;
    ...
    return ColoredBox(
      ...
      child: Stack(
        ...
        children: [
          ...
          const MemoBoardLayer(theme: MemoTheme.rain),
        ],
      ),
    );
  }
