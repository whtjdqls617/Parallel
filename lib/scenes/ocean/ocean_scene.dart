...
/// Sitting on the shore. Clear afternoon. Waves coming in.
...
class _OceanSceneState extends State<OceanScene>
  ...
  @override
  void didUpdateWidget(covariant OceanScene oldWidget) {
  ...
  void _maybeSettleSand(double t) {
    ...
    final total = OceanPainter.sandEraseSeconds +
        OceanPainter.sandPauseSeconds +
        OceanPainter.sandWriteSeconds;
  ...
  int _currentSandCount(double t) {
    ...
    final u = t - changeAt;
    if (u < OceanPainter.sandEraseSeconds) return from;
    return to;
  }
  ...
  ({int sandCount, double reveal, double erase}) _sandInscription(double t) {
    ...
    final u = t - changeAt;
    const eraseDur = OceanPainter.sandEraseSeconds;
    const pauseDur = OceanPainter.sandPauseSeconds;
    const writeDur = OceanPainter.sandWriteSeconds;
    ...
    return ColoredBox(
      ...
      child: Stack(
        ...
        children: [
          ...
          const MemoBoardLayer(theme: MemoTheme.ocean),
        ],
      ),
    );
  }
